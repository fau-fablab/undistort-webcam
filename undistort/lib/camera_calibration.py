...
Taken from:
https://github.com/niconielsen32/opencv-python-tutorials/blob/28cd216a94e0db0716771487a8e4f0b41db02f2e/16_camera_calibration/camera_calibration.py

License: MIT, see LICENSE.camera_calibration
...
class CameraCalibration:
    ...
    def calibrate_camera(self, images, pattern_size=(9, 6), square_size=1.0):
        ...
        for img in images:
            ...
            # Known issue: This can take very very long for images that don't contain the chessboard. https://github.com/opencv/opencv/issues/23558
        ...
        if len(objpoints) < 3:
            raise Exception("Not enough valid calibration images")
